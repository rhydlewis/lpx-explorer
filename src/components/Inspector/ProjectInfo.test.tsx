  ...
  describe("similarity pivots (lpx-explorer-89p)", () => {
    ...
    it("clicking the Key cell sets a key-axis filter, clears the project, and pivots to the containing folder", () => {
      ...
      useProjectStore.setState({
        current: { kind: "loaded", path: "/lib/song-a.logicx", summary: s, alternatives: [{ index: 0, display_name: "song-a", is_active: true, window_image_path: null, last_saved_unix: 0 }], activeVariantIndex: 0, projectInformationMissing: false },
      });
      useLibraryStore.setState({
        folders: [
          {
